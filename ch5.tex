...
% Also mention that we want to measure occurrence rates
...
% Lead into synthetic simulations: want to construct statistical sample to measure occurrence rates
...
\begin{center}
    ...
    \caption{Figure caption goes here.\label{fig:occurrence_syn}}
\end{center}
\end{figure}
